...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for question in saved_questions:
            tags_to_add = random.sample(saved_tags, random.randint(1, min(5, len(saved_tags))))
        ...
        for _ in range(ratio * 100):
            ...
            answer.is_correct = random.choice([True, False])
        ...
        for _ in range(ratio * 200):
            ...
            if key not in key_set_question:
                ...
                question_likes.append(QuestionLike(user=user, question=question, type=like_type))
        ...
        for _ in range(ratio * 200):
            ...
            if key not in key_set_answer:
                ...
                like_type = random.choice(['like', 'dislike'])
                answer_likes.append(AnswerLike(user=user, answer=answer, type=like_type))
